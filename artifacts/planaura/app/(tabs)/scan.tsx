...
const styles = StyleSheet.create({
  ...
  heroCard:{borderRadius:20,borderWidth:1,padding:24,alignItems:"center",gap:12},heroIcon:{width:64,height:64,borderRadius:20,alignItems:"center",justifyContent:"center",shadowColor:"#38BDF8",shadowOffset:{width:0,height:6},shadowOpacity:0.3,shadowRadius:12,elevation:6},heroTitle:{fontSize:22,fontWeight:"800",letterSpacing:-0.4},heroDesc:{fontSize:14,textAlign:"center",lineHeight:21},
  photoBtn:{flexDirection:"row",alignItems:"center",justifyContent:"center",gap:10,paddingVertical:16,borderRadius:16,shadowColor:"#38BDF8",shadowOffset:{width:0,height:6},shadowOpacity:0.28,shadowRadius:16,elevation:6},photoBtnText:{color:"#fff",fontSize:16,fontWeight:"800"},galleryBtn:{flexDirection:"row",alignItems:"center",justifyContent:"center",gap:10,paddingVertical:14,borderRadius:16,borderWidth:1.5},galleryBtnText:{fontSize:15,fontWeight:"700"},
  ...
  nextBtn:{flexDirection:"row",alignItems:"center",justifyContent:"center",gap:10,paddingVertical:16,borderRadius:16,shadowColor:"#38BDF8",shadowOffset:{width:0,height:6},shadowOpacity:0.28,shadowRadius:16,elevation:6},nextBtnText:{color:"#fff",fontSize:16,fontWeight:"800"},
