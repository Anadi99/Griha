      ...
      >
        ...
        >
          ...
          <View style={styles.featuresGrid}>
            {FEATURES.map((f) => (
              <View key={f.label} style={[styles.featureTile, { backgroundColor: colors.card, borderColor: colors.border }]}>
                <View style={[styles.featureTileIcon, { backgroundColor: f.color + "15" }]}>
                  <Feather name={f.icon} size={20} color={f.color} />
                </View>
                <Text style={[styles.featureTileLabel, { color: colors.foreground }]}>{f.label}</Text>
                <Text style={[styles.featureTileDesc, { color: colors.mutedForeground }]}>{f.desc}</Text>
              </View>
            ))}
          </View>
          ...
          {/* Quick tip */}
          <View style={[styles.tipCard, { backgroundColor: colors.primaryMuted, borderColor: colors.primary + "30" }]}>
...
const styles = StyleSheet.create({
  ...
  logoRing: {
    width: 76, height: 76, borderRadius: 24, borderWidth: 1.5,
  ...
  heroBadge: {
    ...
    borderWidth: 1, borderRadius: 20, paddingHorizontal: 12, paddingVertical: 6, marginTop: 4,
  },
  heroBadgeText: { color: "#ffffffCC", fontSize: 13, fontWeight: "500" },

  body: { paddingHorizontal: 16, paddingTop: 24, gap: 0 },

  ctaGroup: { gap: 10, marginBottom: 28 },
  ctaPrimary: {
  ...
  featureTile: {
    width: "47%", flexGrow: 1, padding: 16, borderRadius: 16, borderWidth: 1, gap: 8,
  ...
  statsStrip: {
    flexDirection: "row", borderRadius: 16, borderWidth: 1, marginBottom: 16, overflow: "hidden",
    shadowColor: "#000", shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.04, shadowRadius: 4, elevation: 1,
  },
